...
export function DetectClient({ fontClassName }: DetectClientProps) {
  ...
  return (
    ...
    >
      ...
      <button
        className="fixed bottom-8 right-8 z-40 flex h-16 w-16 items-center justify-center rounded-full bg-[#2e7d32] text-white shadow-2xl transition-all hover:scale-105 active:scale-95 md:hidden"
